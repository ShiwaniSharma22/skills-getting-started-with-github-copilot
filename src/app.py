...
activities = {
    ...
    "Basketball Club": {
        "description": "Join the basketball team and compete in intramural games",
    ...
    "Music Ensemble": {
        "description": "Perform in the school band, orchestra, or choir",
    ...
    "Robotics Club": {
        "description": "Build and compete with robots in engineering challenges",
